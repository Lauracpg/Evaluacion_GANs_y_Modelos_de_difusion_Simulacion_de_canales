...
class Discriminator(nn.Module):
    def __init__(self, L):
        ...
        # Capa final: convierte las características en un único valor
...
def train_gan(G, D, loader, device, config):
    ...
    # Loss tipo MSE: el discriminador aprende a dar valores cercanos a 1 o 0
