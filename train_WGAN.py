...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr', type=float, default=5e-5, help='Learning rate (tasa de aprendizaje)')
    parser.add_argument('--n_critic', type=int, default=7,help='Número de updates del critic por update del generator')
    parser.add_argument('--lambda_gp', type=float,default=15.0, help='Peso del gradient penalty')
    parser.add_argument('--patience', type=int, default=40,help='Paciencia para early stopping')
    parser.add_argument('--min_delta', type=float,default=5e-4,help='Mejora mínima en Wasserstein distance')
